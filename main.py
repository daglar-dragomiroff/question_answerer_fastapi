...
class Item(BaseModel):
    # Наша модель ищет ответ на вопрос в заданном тексте => Пользователь должен иметь
    # возможность ввести текст и вопрос, ответ на который модель должна искать в этом тексте.
    # => ипользуем список, в котором в 0-ом элементе будем хранить сам текст, а в 1-м элементе вопрос.
